<template>
  <div class="row">
    <TableItemsPerPageSelect v-model:itemsPerPage="itemsCountInTable"
...
<script lang="ts">
import TableItemsPerPageSelect from "@/assets/template/layouts/default-layout/components/datatable/table-lists/table-content/table-footer/TableItemsPerPageSelect.vue";
