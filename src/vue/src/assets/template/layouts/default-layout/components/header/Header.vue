<template>
  ...
  <div v-if="headerDisplay" id="kt_app_header" class="app-header">
    ...
    >
      ...
      >
        <router-link to="/">
          <img
            ...
            class="h-40px h-lg-50px app-sidebar-logo-default theme-light-show"
          />
          <img
            v-if="
              layout === 'dark-header' ||
      ...
      >
        <KTHeaderMenu />
        <KTHeaderNavbar :data="userLogged" />
      </div>
      <!--end::Header wrapper-->
    </div>
...
import KTHeaderMenu from "@/assets/template/layouts/default-layout/components/header/menu/Menu.vue";
import KTHeaderNavbar from "@/assets/template/layouts/default-layout/components/header/Navbar.vue";
import {
  headerDisplay,
  headerWidthFluid,
  layout,
  ...
  headerDesktopFixed,
  headerMobileFixed,
} from "@/assets/template/layouts/default-layout/utils/helper";
