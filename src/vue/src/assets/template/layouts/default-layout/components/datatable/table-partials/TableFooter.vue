...
<script lang="ts">
import TableItemsPerPageSelect from "@/assets/template/layouts/default-layout/components/datatable/table-partials/table-content/table-footer/TableItemsPerPageSelect.vue";
