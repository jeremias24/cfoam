<template>
    <!--begin::Form-->
    <form
      class="mx-auto mw-100 w-100 pt-15 pb-10"
      novalidate
      id="kt_create_account_form"
    >
      <slot name="stepper_content"></slot>
      ...
      <div class="d-flex flex-stack pt-15">
        ...
        <div>
          ...
          <button v-else type="submit" class="btn btn-sm btn-primary">
            Continue
  ...
  import { StepperComponent } from "@/assets/template/ts/components";
...
//   const formInitData = ref<ICreateAccount>(formData.value);
  ...
  onMounted(() => {
    nextTick(() => {
      if (props.stepperEl) {
        stepperObj.value = StepperComponent.createInstance(props.stepperEl);
      }
    });
  });
