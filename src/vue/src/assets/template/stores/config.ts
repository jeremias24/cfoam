...
import type LayoutConfigTypes from "@/assets/template/layouts/default-layout/types/layout";
import layoutConfig from "@/assets/template/layouts/default-layout/configs/DefaultLayoutConfig";
