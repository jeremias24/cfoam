...
import Reject from "@/components/forms/Approvals/Reject.vue";
        ...
        .then(({ data }) => {
          ...
          setTimeout(() => {
                ...
                if (approvals.length) {
                  ...
                  if (pendingApprovals.length) {
                    if (
                      ...
                      pendingApprovals[0]?.approverId == null &&
            ...
            if (initAction.value == "Confirm") {
              initForm.value = Confirm;
            } else if (initAction.value == "Reject") {
              initForm.value = Reject;
            } else {
              router.push(
                `/approvals/notification/${MixinService.encrypt(
                  JSON.stringify({
                    action: initAction.value,
                    id: initData.value?.approvalId,
